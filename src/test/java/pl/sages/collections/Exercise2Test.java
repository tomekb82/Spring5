...
public class Exercise2Test {
  ...
  public void mergeValues() {
     ...
     */
    BiFunction<Integer, Integer, Integer> remappingFunction = (startValue, value) -> startValue!=null ? value+startValue : value;
  ...
  public void ignoringAbsentKeys() {
     ...
     */
    BiFunction<String, Integer, Integer> remappingFunction = (key, startValue) -> ++startValue;
